  ...
  before(async () => {
    ...
    await dbConnection
      .dbConnect('INSERT into users(email, firstName, lastName, password, type, isAdmin) values($1, $2, $3, $4, $5, $6)',
        ['staff@banka.com', 'cavdy', 'ikenna', process.env.ADMIN_PWD, 'staff', false]);
    await dbConnection
      .dbConnect('INSERT into users(email, firstName, lastName, password, type, isAdmin) values($1, $2, $3, $4, $5, $6)',
        ['admin@banka.com', 'cavdy', 'ikenna', process.env.ADMIN_PWD, 'client', true]);
    await dbConnection
      .dbConnect('INSERT into users(email, firstName, lastName, password, type, isAdmin) values($1, $2, $3, $4, $5, $6)',
        ['deleteguy@banka.com', 'cavdy', 'ikenna', process.env.ADMIN_PWD, 'staff', true]);
    await dbConnection
      .dbConnect('INSERT into users(email, firstName, lastName, password, type, isAdmin) values($1, $2, $3, $4, $5, $6)',
        ['deleteguy2@banka.com', 'cavdy', 'ikenna', process.env.ADMIN_PWD, 'client', true]);
  });
  after(async () => {
    await dbConnection
